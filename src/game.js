...
export function movingGhost(map, ghost, checkLose, eatGhost, ghostArray, rick, morty, keyMovement, timer, score) {
...
export function powerUpEaten(map, rick, morty, score, scoreDisplay, ghostArray, timer ) {
...
export function checkLose(map, keyMovement, timer, rick, morty, score) {
    var lost = false;
